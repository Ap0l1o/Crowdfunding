...
import { Funding, getMyFundings, addListener } from '../api/contract'
...
export default defineComponent({
  name: 'Myself',
  components: { CheckCircleOutlined, SyncOutlined, CloseCircleOutlined },
  setup() {
    ...
    return { state, columns, moreDetail }
  }
});
</script>
